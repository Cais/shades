<?php /* standard Shades content loop */ ?>

<?php /* Check if the content is being displayed on a "page" */
if ( is_page() ) { ?>
  ...
  <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
  	...
  	<div class="postdata">
      <?php printf( __( 'Posted by %1$s on %2$s', 'shades' ), get_the_author(), get_the_time( get_option( 'date_format' ) ) );
...
<?php } ?>
<?php /* Last revised September 11, 2011 v1.7 */ ?>